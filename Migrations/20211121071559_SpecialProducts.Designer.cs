...
namespace YgoProgressionDuels.Migrations
{
    ...
    [Migration("20211121071559_SpecialProducts")]
            ...
            modelBuilder.Entity("YgoProgressionDuels.Data.SpecialProductCard", b =>
                {
                    ...
                    b.Property<string>("SpecialProductSetCode")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("SpecialProductSetName")
                        .HasColumnType("nvarchar(450)");

                    b.HasKey("SpecialProductCardId");

                    b.HasIndex("SpecialProductSetName", "CardInfoId")
                        .IsUnique()
                        .HasFilter("[SpecialProductSetName] IS NOT NULL");
