...
namespace YgoProgressionDuels.Migrations
{
    ...
    [Migration("20210718201305_TournamentRounds")]
    partial class TournamentRounds
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("YgoProgressionDuels.Data.Tournament", b =>
                {
                    ...
                    b.Property<long>("TournamentNumber")
                        .HasColumnType("bigint");

                    b.HasKey("TournamentId");

                    b.HasIndex("BoosterPackInfoId");

                    b.HasIndex("ProgressionSeriesId", "TournamentNumber")
                        .IsUnique();
            ...
            modelBuilder.Entity("YgoProgressionDuels.Data.TournamentPairing", b =>
                {
                    ...
                    b.Property<Guid>("Duelist1Id")
                        .HasColumnType("uniqueidentifier");

                    b.Property<int>("Duelist1Score")
                        .HasColumnType("int");

                    b.Property<Guid?>("Duelist2Id")
                        .HasColumnType("uniqueidentifier");

                    b.Property<int>("Duelist2Score")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("Duelist1Id");

                    b.HasIndex("Duelist2Id");

                    b.HasIndex("TournamentRoundId", "Duelist1Id", "Duelist2Id")
                        .IsUnique()
                        .HasFilter("[Duelist2Id] IS NOT NULL");

                    b.ToTable("TournamentPairings");
                });

            modelBuilder.Entity("YgoProgressionDuels.Data.TournamentRound", b =>
                {
                    b.Property<Guid>("PairingId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("YgoProgressionDuels.Data.Tournament", b =>
                {
                    b.HasOne("YgoProgressionDuels.Data.BoosterPackInfo", "CurrentBoosterPack")
                        .WithMany()
                        .HasForeignKey("BoosterPackInfoId");

                    b.HasOne("YgoProgressionDuels.Data.ProgressionSeries", "ProgressionSeries")
                        .WithMany("Tournaments")
                        .HasForeignKey("ProgressionSeriesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("CurrentBoosterPack");

                    b.Navigation("ProgressionSeries");
                });

            modelBuilder.Entity("YgoProgressionDuels.Data.TournamentPairing", b =>
                {
                    b.HasOne("YgoProgressionDuels.Data.Duelist", "Duelist1")
                        .WithMany()
                        .HasForeignKey("Duelist1Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("YgoProgressionDuels.Data.Duelist", "Duelist2")
                        .WithMany()
                        .HasForeignKey("Duelist2Id");

                    b.HasOne("YgoProgressionDuels.Data.TournamentRound", "Round")
                        .WithMany("Pairings")
                        .HasForeignKey("TournamentRoundId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Duelist1");

                    b.Navigation("Duelist2");
            ...
            modelBuilder.Entity("YgoProgressionDuels.Data.TournamentRound", b =>
                {
                    b.HasOne("YgoProgressionDuels.Data.Tournament", "Tournament")
                        .WithMany("Rounds")
