...
namespace YgoProgressionDuels.Migrations
{
    ...
    [Migration("20210707211351_RenameFirstAttainedToDateObtained")]
    partial class RenameFirstAttainedToDateObtained
    {
            ...
            modelBuilder.Entity("YgoProgressionDuels.Data.BanListEntry", b =>
                {
                    ...
                    b.HasIndex("SeriesId", "CardName")
                        .IsUnique()
                        .HasFilter("[CardName] IS NOT NULL");

                    b.ToTable("BanListEntry");
                });
