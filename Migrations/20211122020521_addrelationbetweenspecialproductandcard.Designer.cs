...
namespace YgoProgressionDuels.Migrations
{
    ...
    [Migration("20211122020521_addrelationbetweenspecialproductandcard")]
    partial class addrelationbetweenspecialproductandcard
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("YgoProgressionDuels.Data.BoosterPackInfo", b =>
                {
                    ...
                    b.Property<bool>("IsStructureDeck")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("YgoProgressionDuels.Data.PairingDuelist", b =>
                {
                    b.Property<Guid>("PairingDuelistId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasKey("PairingDuelistId");

                    b.HasIndex("PairingId", "Username")
                        .IsUnique()
                        .HasFilter("[Username] IS NOT NULL");

                    b.ToTable("PairingDuelists");
                });
            ...
            modelBuilder.Entity("YgoProgressionDuels.Data.ProgressionSeries", b =>
                {
                    ...
                    b.Property<bool>("AllowPurchaseSpecialProducts")
                        .HasColumnType("bit");

                    b.Property<bool>("AllowPurchaseStructureDecks")
                        .HasColumnType("bit");
                    ...
                    b.Property<long>("SpecialProductPricePerCard")
                        .HasColumnType("bigint");

                    b.Property<long>("StructureDeckPrice")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("YgoProgressionDuels.Data.SpecialProduct", b =>
                {
            ...
            modelBuilder.Entity("YgoProgressionDuels.Data.SpecialProductCard", b =>
                {
                    b.Property<Guid>("SpecialProductCardId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("CardInfoName")
                        .HasColumnType("nvarchar(max)");

                    b.Property<Guid>("OwnerProductId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<string>("Rarity")
                        .HasColumnType("nvarchar(max)");

                    b.HasKey("SpecialProductCardId");

                    b.HasIndex("OwnerProductId", "CardInfoId")
                        .IsUnique();

                    b.ToTable("SpecialProductCards");
                });

            modelBuilder.Entity("YgoProgressionDuels.Data.StructureDeckCard", b =>
                {
                    b.Property<Guid>("StructureDeckCardId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("StructureDeckSetCode")
                        .HasColumnType("nvarchar(450)");

                    b.HasKey("StructureDeckCardId");

                    b.HasIndex("StructureDeckSetCode", "CardInfoId")
                        .IsUnique()
                        .HasFilter("[StructureDeckSetCode] IS NOT NULL");

                    b.ToTable("StructureDeckCards");
                });

            modelBuilder.Entity("YgoProgressionDuels.Data.Tournament", b =>
                {
                    b.Property<Guid>("TournamentId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<string>("BoosterPackCode")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("YgoProgressionDuels.Data.TournamentDuelist", b =>
                {
                    b.Property<Guid>("TournamentDuelistId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<int>("OpponentsDefeated")
                        .HasColumnType("int");

                    b.Property<int>("OpponentsOpponentsDefeated")
                        .HasColumnType("int");
                    ...
                    b.HasKey("TournamentDuelistId");

                    b.HasIndex("TournamentId", "Username")
                        .IsUnique()
                        .HasFilter("[Username] IS NOT NULL");

                    b.ToTable("TournamentDuelists");
                });

            modelBuilder.Entity("YgoProgressionDuels.Data.TournamentPairing", b =>
                {
            ...
            modelBuilder.Entity("YgoProgressionDuels.Data.PairingDuelist", b =>
                {
                    b.HasOne("YgoProgressionDuels.Data.TournamentPairing", "OwnerPairing")
                        .WithMany("Duelists")
                        .HasForeignKey("PairingId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("OwnerPairing");
                });
            ...
            modelBuilder.Entity("YgoProgressionDuels.Data.SpecialProductCard", b =>
                {
                    b.HasOne("YgoProgressionDuels.Data.SpecialProduct", "OwnerProduct")
                        .WithMany("Cards")
            ...
            modelBuilder.Entity("YgoProgressionDuels.Data.TournamentDuelist", b =>
                {
                    b.HasOne("YgoProgressionDuels.Data.Tournament", "OwnerTournament")
                        .WithMany("Duelists")
                        .HasForeignKey("TournamentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("OwnerTournament");
                });
